...
<div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{route('mapel.store')}}" method="post">
            {{csrf_field()}}
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Kelas</label>
                  <input type="text" class="form-control" name="n_mapel" id="exampleInputEmail1" placeholder="Nama Kelas">
                </div> 
              </div>
              <!-- /.box-body -->
...
<div class="modal modal-primary fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="{{route('mapel.update',$mapel->id)}}" method="post">
            ...
            @method('PUT')
              <div class="box-body">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="n_mapel"
                  value="{{$mapel->n_mapel}}">       
              </div>
